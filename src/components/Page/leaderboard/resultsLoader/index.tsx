...
import { getPublicQuizResultDatasets, getQuizResultsFromDatasets, sorQuizResultDatas } from '../../../../helpers/QuizResultsListHelper';
...
export const ResultsLoader: React.FC<Props> = (props: Props) => {
	...
	useEffect(() => {
		SpinAround(async () => {
			...
			sorQuizResultDatas(filteredQuizResultsData);
