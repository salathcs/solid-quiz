...
export const SOLID_QUIZ_POD = "https://test-solid-quiz.solidcommunity.net/";
export const SOLID_QUIZ_POD_SHARES_DATASET = "https://test-solid-quiz.solidcommunity.net/workspace/solidQuiz/shares/index.ttl";